...
print(text.split()) # split() prints the entire text as a list of words.

word_count = {} # empty dictionary.

for word in text.lower().split():
    if word in word_count:
        word_count[word] += 1 # prints each word in the list.
    else:
        word_count[word] = 1
print(word_count) # prints the entire list of words.